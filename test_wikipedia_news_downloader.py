...
class TestSplitAndCleanMarkdown(unittest.TestCase):
    ...
    def test_split_and_clean_from_issue_example(self):
        ...
        self.assertTrue(md_june1.strip().endswith("[(France 24)](https://www.france24.com/en/live-news/20250602-cruz-azul-thrash-vancouver-whitecaps-to-win-concacaf-champions-cup)"), "June 1 MD incorrect end")
        ...
        self.assertTrue(md_june2.strip().endswith("[(DW)](https://www.dw.com/en/death-toll-in-nigeria-flooding-rises-to-at-least-200/video-72755995)"), "June 2 MD incorrect end")
        ...
        self.assertIn("[CJ Opiaza](https://en.wikipedia.org/wiki/CJ_Opiaza", md_june3) # Check a name that had a redlink in original example
        self.assertNotIn("June\xa03,\xa02025", md_june3)
        self.assertTrue(md_june3.strip().endswith("[(ABS-CBN News)](https://www.abs-cbn.com/lifestyle/2025/6/3/-this-is-my-golden-moment-cj-opiaza-in-tears-at-miss-grand-international-coronation-1626)"), "June 3 MD incorrect end")

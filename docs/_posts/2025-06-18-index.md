...
* [Starship flight test 10](https://en.wikipedia.org/wiki/Starship_flight_test_10 "Starship flight test 10")
  * [SpaceX Starship 36](https://en.wikipedia.org/wiki/List_of_Starship_vehicles#Ship_36 "List of Starship vehicles") explodes when a "major anomaly" occurs during a static fire test. [(KRIV-TV via Yahoo! News)](https://www.yahoo.com/news/spacex-explosion-starship-explodes-prior-050026630.html)

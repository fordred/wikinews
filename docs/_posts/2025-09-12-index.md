...
date: 2025-09-12
last_modified_at: 2025-09-12 18:47
published: true
---
...
* [Israeli-Palestinian conflict](https://en.wikipedia.org/wiki/Israeli-Palestinian_conflict "Israeli-Palestinian conflict"), [Eightieth session of the United Nations General Assembly](https://en.wikipedia.org/wiki/Eightieth_session_of_the_United_Nations_General_Assembly "Eightieth session of the United Nations General Assembly")
  * The [UN General Assembly](https://en.wikipedia.org/wiki/UN_General_Assembly "UN General Assembly") calls for a [ceasefire](https://en.wikipedia.org/wiki/Ceasefire "Ceasefire"), the release of hostages, the disarmament of [Hamas](https://en.wikipedia.org/wiki/Hamas "Hamas"), and renewed momentum toward a [two-state](https://en.wikipedia.org/wiki/Two-state_solution "Two-state solution") peace settlement. The assembly votes 142–10 with 12 abstentions to adopt the [New York Declaration](https://en.wikipedia.org/wiki/July_2025_Conference_on_the_Implementation_of_the_Two-State_Solution#New_York_Declaration "July 2025 Conference on the Implementation of the Two-State Solution"). [(*The Guardian*)](https://www.theguardian.com/world/2025/sep/12/un-general-assembly-to-back-hamas-free-government-for-palestine)

...
date: 2025-09-11
last_modified_at: 2025-09-11 20:07
published: true
---
...
* Nineteen people are killed and several others are missing in [flash floods](https://en.wikipedia.org/wiki/Flash_flood "Flash flood") on the [Flores](https://en.wikipedia.org/wiki/Flores "Flores") and [Bali](https://en.wikipedia.org/wiki/Bali "Bali") islands of [Indonesia](https://en.wikipedia.org/wiki/Indonesia "Indonesia"). [(DW)](https://www.dw.com/en/indonesia-19-dead-after-flash-floods/a-73959609)
...
* [Politics of Albania](https://en.wikipedia.org/wiki/Politics_of_Albania "Politics of Albania"), [Corruption in Albania](https://en.wikipedia.org/wiki/Corruption_in_Albania "Corruption in Albania")
  * [Albania](https://en.wikipedia.org/wiki/Albania "Albania") appoints an [AI](https://en.wikipedia.org/wiki/AI "AI") bot named "Diella" as Minister of Public Procurement, in an effort to increase [transparency](https://en.wikipedia.org/wiki/Transparency_%28behavior%29 "Transparency (behavior)") and reduce [corruption](https://en.wikipedia.org/wiki/Corruption "Corruption") in state contracts. This marks the first time a [ministerial](https://en.wikipedia.org/wiki/Minister_%28government%29 "Minister (government)") has been given to an AI System. [(Tribune)](https://tribune.com.pk/story/2566250/albania-names-ai-bot-as-minister-to-oversee-procurement-fight-corruption)

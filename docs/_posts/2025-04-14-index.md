...
* [Demographics of Japan](https://en.wikipedia.org/wiki/Demographics_of_Japan "Demographics of Japan"), [Population decline](https://en.wikipedia.org/wiki/Population_decline "Population decline")
  + [Aging of Japan](https://en.wikipedia.org/wiki/Aging_of_Japan "Aging of Japan")
    - According to official data, the [population](https://en.wikipedia.org/wiki/Population "Population") of [Japanese citizens](https://en.wikipedia.org/wiki/Japanese_citizens "Japanese citizens") dropped to a record low of 120.3 million by October 2024, following a 14-year trend of record lows and the largest drop since records began in 1950. [(DW)](https://www.dw.com/en/japan-sees-record-drop-in-population/a-72239612) [(Government of Japan)](https://www.stat.go.jp/data/jinsui/new.html)

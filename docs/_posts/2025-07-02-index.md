...
* [3I/ATLAS](https://en.wikipedia.org/wiki/3I/ATLAS "3I/ATLAS")
  * The [Minor Planet Center](https://en.wikipedia.org/wiki/Minor_Planet_Center "Minor Planet Center") confirms an [interstellar object](https://en.wikipedia.org/wiki/Interstellar_object "Interstellar object"), formally designated *3I/ATLAS*, is transiting the [Solar System](https://en.wikipedia.org/wiki/Solar_System "Solar System") and will make its closest approach to the [Sun](https://en.wikipedia.org/wiki/Sun "Sun") in October 2025. It is the third interstellar object to be officially confirmed to have entered our Solar System. The object is likely a [comet](https://en.wikipedia.org/wiki/Comet "Comet") and could be as large as 12 miles (20 km) in diameter, according to the latest data. [(Minor Planet Center)](https://minorplanetcenter.net/mpec/K25/K25N12.html) [(Earth Sky)](https://earthsky.org/space/new-interstellar-object-candidate-heading-toward-the-sun-a11pl3z/)
